...
export const STATUS_CONFIG: Record<ItemStatus, { label: string; emoji: string; color: string }> = {
  backlog: { label: "Backlog", emoji: "📋", color: "text-slate-500" },
  todo: { label: "Todo", emoji: "⬜", color: "text-sky-400" },
  in_progress: { label: "In Progress", emoji: "🔄", color: "text-amber-400" },
  done: { label: "Done", emoji: "✅", color: "text-emerald-500" },
  canceled: { label: "Canceled", emoji: "❌", color: "text-red-500" },
  duplicate: { label: "Duplicate", emoji: "🔗", color: "text-violet-400" },
};
